...
import ProbeSolverResults from './ProbeSolverResults';
...
function App() {
    ...
    const setSelectedSequences = (data) => {
        console.log(data); // TODO: remove
        setWindowState(windowState+1);
        setProcessData(data);
    };
    ...
    return (<>
        ...
        </h1>
        {
            /* switch(windowState) */{ 
                ...
                1: <ProbeSolverSubselect processData={processData} setSelectedSequences={setSelectedSequences} />,
                2: <ProbeSolverResults jid={processData !== undefined ? processData.jid : undefined} />,
            }[windowState]
        }
    </>);
}
